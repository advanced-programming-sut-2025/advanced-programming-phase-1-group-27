...
public enum ProcessedProductType implements Item {
    Honey(Recipe.HoneyRecipe, 75, 350, 4 * 15),
    ...
    Beer(Recipe.BeerRecipe, 50, 200, 15),
    Vinegar(Recipe.VinegarRecipe, 13, 100, 10),
    Coffee(Recipe.CoffeeRecipe, 75, 150, 2),
    Juice(Recipe.JuiceRecipe, null, null, 4 * 15),
    Mead(Recipe.MeadRecipe, 100, 300, 10),
    PaleAle(Recipe.PaleAleRecipe, 50, 300, 3 * 15),
    Wine(Recipe.WineRecipe, null, null, 7 * 15),
    ...
    Jelly(Recipe.JellyRecipe, null, null, 3 * 15),
