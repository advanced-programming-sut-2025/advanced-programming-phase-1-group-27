...
public class FarmMapDirector {
    ...
    public void buildMapAshghal(FarmMapBuilder builder, int index) {
        ...
        if (index == 0) {
            builder.createSmallLake(30, 64);
            builder.createBigLake(45, 30);
            builder.setPassageToNpcValley(54, 74, 6, 1, App.getCurrentGame().getNpcMap());
            App.getCurrentGame().getNpcMap().setPassageToFarmMap(6, 0, builder.getFinalProduct(), 54, 73);
        } else if (index == 1) {
            builder.createBigLake(25, 7);
            builder.setPassageToNpcValley(0, 74, 15, 1, App.getCurrentGame().getNpcMap());
            ...
            builder.createSmallLake(32, 40);
            builder.createSmallLake(21, 21);
            builder.setPassageToNpcValley(54, 0, 6, 32, App.getCurrentGame().getNpcMap());
