...
public class BlackSmithShop extends AppMenu {
    ...
    private void displayCheckBox() {
        showOnlyAvailableCheckBox.setPosition(Gdx.graphics.getWidth() - 200, Gdx.graphics.getHeight() / 2f + 200);
    ...
    private void displayButtons() {
        ...
        upgradeButton.setPosition(Gdx.graphics.getWidth() - 300, Gdx.graphics.getHeight() / 2f - 40);
